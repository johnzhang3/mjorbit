...
These tests verify that the CPU simulator's gravity, J2, magnetic field,
...
from mjorbit.constants import GM_EARTH, R_EARTH, J2_EARTH, B0_EARTH, OMEGA_EARTH, P_SUN
from mjorbit.cpu.orbit.gravity import point_mass_accel, j2_accel, total_accel
from mjorbit.cpu.orbit.elements import keplerian_to_cartesian, cartesian_to_keplerian
from mjorbit.cpu.orbit.propagator import propagate_rk4
...
class TestAtmRelVelParity:
    ...
    def test_corotation_correction(self):
        ...
        # Atmosphere velocity at this point: omega_earth x R = [0, 0, omega] x [r, 0, 0] = [0, omega*r, 0]
