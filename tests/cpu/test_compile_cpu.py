"""Phase 0 + Phase 3 tests: compile_cpu, scenario state, body helpers."""
...
from mjorbit.cpu.core.config import (
    ...
    SurfaceCfg, MagneticBodyCfg, ReactionWheelCfg, MagnetorquerCfg, ThrusterCfg,
)
...
def _circular_leo_cfg(alt_km: float = 400.0, **overrides) -> CPUScenarioCfg:
    a = R_EARTH + alt_km
