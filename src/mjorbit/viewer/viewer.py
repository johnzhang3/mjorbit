...
Coordinate system
-----------------
Everything is rendered in the MuJoCo world frame which, in mjorbit, is
...
from mjorbit.viewer.bodies import MuJoCoScene
from mjorbit.viewer.earth import BodyTrail, add_earth
...
class MjOrbitViewer:
    ...
    def run(
        ...
        action_fn: Optional[Callable[[CPUScenario, float], Optional[np.ndarray]]] = None,
    ) -> None:
            ...
            while sim_t < duration:
                ...
                if not self._paused:
                    ...
                    while budget >= dt and sim_t < duration:
                        ...
                        step_cpu(self.scenario, ctrl=ctrl)
                        sim_t += dt
                        budget -= dt
                        steps += 1
